                                ...
                                <div class="pad">
                                    {!! Form::open(['id'=>'form-cetak-klinik', 'method'=>'POST', 'url'=>'/laporan/lap-klinik']) !!}
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                {!! Form::select('jenis', ['utama'=>'Data Utama','penyakit'=>'Peta Penyakit','Vaksinasi'=>'Vaksinasi','Operasi'=>'Operasi','Doperasi'=>'Obat dan Bahan Operasi','pad'=>'Laporan PAD','bulanan'=>'Laporan Bulanan Obat'],null, ['class'=>'form-control']) !!}
                                            </div>
                                        </div>
										<div id="form_tahun">
											<div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
												...
												-->
												{!! Form::select('format', ['Excel'=>'Excel'], null, ['class'=>'form-control']) !!}
                                            </div>
                                        </div>
...
@section('javascript')
    <script type="text/javascript">
        ...
        $('#btnPrev').click(function(e){
                ...
                $("#prev").load('{!! url('/laporan/lap-klinik-prev') !!}?dari_tanggal='+dari_tanggal+'&sampai_tanggal='+sampai_tanggal+'&sub_satuan_kerja_id='+sat+'&format='+format+'&jenis='+jenis+'&tahun='+tahun);
            });
    </script>
@endsection
