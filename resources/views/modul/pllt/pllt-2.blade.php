                                        ...
                                        @endif
                                            ...
                                            <section>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        {!! Form::select('satuan', ['Kilogram'=>'Kilogram'], null, ['class'=>'form-control']) !!}
                                                    </div>
                                                </div>
                                                <div class="form-group row">
...
@section('javascript')
    <script>
        ...
        function tampilDataHewan(method='create', id=''){
            $("#areaDataHewan").load('{!! url('/pllt/area-data-hewan') !!}?method='+method+'&id='+id);
        }
