                ...
                <div class="box box-default">
                    ...
                    <div class="box-body">                      
                        <table style="border-collapse:collapse;border:1px solid gray;">
                            <thead>
                                <tr style="border-collapse:collapse;border:1px solid gray;"><th style="border-collapse:collapse;border:1px solid gray;">No</th><th style="border-collapse:collapse;border:1px solid gray;">Tanggal Periksa</th><th style="border-collapse:collapse;border:1px solid gray;">Signalment</th><th style="border-collapse:collapse;border:1px solid gray;">Anamnesa</th><th style="border-collapse:collapse;border:1px solid gray;">Diagnosa</th><th>Tindakan Penanganan dan Keterangan Tindakan</th><th style="border-collapse:collapse;border:1px solid gray;">Keterangan</th><th>Pemeriksa</th><th>Paramedis</th></tr>
                            </thead>
                            <tbody>
                                @php
                                    $no = 1;
                                ...
                                <tr style="border-collapse:collapse;border:1px solid gray;">
                                    <td style="border-collapse:collapse;border:1px solid gray;">{{$no}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{date('d F Y',strtotime($dat->tanggal_periksa))}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{$dat->signalement}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{$dat->anamnesia}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{$diagnosa[$dat->id]->penyakit}}</td>
                                    <td style="border-collapse:collapse;border:1px solid gray;">
                                    @foreach($dosis[$dat->id] as $dos)
                                        
											
											@if($dos->tindakan == 1 or $dos->tindakan == 2 or $dos->tindakan == 3)
												{{$dos->obat}}
                                    ...
                                    @endforeach
                                    </td><td style="border-collapse:collapse;border:1px solid gray;">{{$dat->keterangan}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{$dat->nmpemeriksa}}</td><td style="border-collapse:collapse;border:1px solid gray;">{{$dat->paramedis}}</td>
                                </tr>
