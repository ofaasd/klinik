...
<ul class="nav nav-tabs">
	...
	<li class="nav-item"><a href="{{ url('klinik/pemeriksaan') }}" class="nav-link {{($url == 'pemeriksaan')?'active':''}}"><span class="hidden-sm-up"><b>Pemeriksaan</b></span> <span class="hidden-xs-down"><b>Pemeriksaan</b></span></a></li>
