...
class HomeController extends Controller
{
    ...
    public function index(Request $request)
    {
		...
		foreach($bulan_pad as $key=>$bulan){
			$var['pad_bulanan'][] = DB::table("pembayaran")->join("klinik_terapi","pembayaran.klinik_terapi_id","klinik_terapi.id")->whereMonth("klinik_terapi.tanggal_periksa",$key)->whereYear("klinik_terapi.tanggal_periksa",$curr_tahun)->sum("total");
			$var['bulan_pad'][] = $bulan;
		}
